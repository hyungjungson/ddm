		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-4">
							<h4 class="card-title mb-0">ROAD SHOW</h4>
						</div>
						<!--/.col-->
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="text-center" scope="col">커버이미지</th>
							...
							<tbody>
								...
								?>
								<tr>
									<th class="align-middle text-center" scope="row"><?=$virtualnum-$i?></th>
									<td class="align-middle text-center">
										<a href="write?table=<?=$table?>&idx=<?=$idx?>&page_now=<?=$page_now?>">
											<img src="<?=$img?>" class="rounded" alt="<?=$title?>" style="max-height:80px;"/>
										</a>
									</td>
									<td class="align-middle text-center">
										<a href="write?table=<?=$table?>&idx=<?=$idx?>&page_now=<?=$page_now?>"><?=$title?></a>
									</td>
									<td class="align-middle text-center">
										<a href="write?table=<?=$table?>&idx=<?=$idx?>&page_now=<?=$page_now?>"><?=$title_sub?></a>
									</td>
